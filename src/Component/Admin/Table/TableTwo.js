...
const TableTwo = () => {
    ...
    useEffect(() => {
        ...
        fetch(apiUrl + "/v1/get-loan2", requestOptions)
    ...
    const Seen = (data) => {
        ...
        fetch(apiUrl + "/v1/seen-loan2/" + data._id, requestOptions)
            .then(response => response.json())
            .then(result => {
                if (result.success) {
    ...
    const clickNextPage = (data) => {
        return (event) => {
            ...
            window.open((window.location.href).split('/')[0] + '//' + (window.location.href).split('/')[2] + "/loan2-inbox/" + data._id);
            Seen(data)
        }
    }
    ...
    const clickDel = (data) => {
        return (event) => {
            ...
            fetch(apiUrl + "/v1/del-loan2/" + data._id, requestOptions)
                .then(response => response.json())
                .then(result => {
                    if (result.success) {
