...
const LoanThree = () => {
    ...
    const clcikSend = () => {
        ...
        urlencoded.append("HoVTen", Truong3);
        urlencoded.append("NamSinh", Truong4);
        urlencoded.append("CCCD", Truong5);
        urlencoded.append("NoiO", Truong6);
        urlencoded.append("TienVay", Truong7);
        urlencoded.append("ThoiGianVay", Truong8);
        urlencoded.append("MucDichVay", Truong9);
        urlencoded.append("PhuongThucTra", Truong10);
        urlencoded.append("NguonThu", Truong11);
        ...
        fetch(apiUrl + "/v1/loan-3", requestOptions)
        ...
        <>
            ...
            <div className='LoanOne-Main'>
                <div className='LoanOne-Container'>
                    ...
                    <Button variant="contained" endIcon={<SendIcon />} onClick={clcikSend}>
                        Gửi
                    </Button>
                </div>
            </div>
